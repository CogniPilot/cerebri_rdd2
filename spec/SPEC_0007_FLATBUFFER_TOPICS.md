...
**REQUIRED:**
- Topic schemas and generated FlatBuffer C headers come from the pinned `synapse_fbs-c.tar.gz` release asset.
- Active schemas are staged under `${CMAKE_BINARY_DIR}/generated/flatbuffers`.
