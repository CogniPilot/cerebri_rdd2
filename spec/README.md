...
| [SPEC_0003](SPEC_0003_RATE_MODE_CONTROL_SCOPE.md) | Flight Control Scope | control | ~65 | ACCEPTED |
| [SPEC_0004](SPEC_0004_TROPIC_HARDWARE_SCOPE.md) | Tropic Hardware Scope | hardware | ~45 | ACCEPTED |
| [SPEC_0005](SPEC_0005_GNSS_STAGING.md) | GNSS Staging | hardware | ~35 | ACCEPTED |
...
| [SPEC_0009](SPEC_0009_NATIVE_SIM_LOCKSTEP.md) | Native Sim Lockstep Transport | simulation | ~35 | ACCEPTED |
...
- Read `SPEC_0009` before changing native-sim lockstep transport or simulator message contracts.
