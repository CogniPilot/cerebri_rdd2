#ifndef RDD2_ZROS_SERIAL_H_
#define RDD2_ZROS_SERIAL_H_
...
#define RDD2_ZROS_SERIAL_HEADER_SIZE  8U
#define RDD2_ZROS_SERIAL_TRAILER_SIZE 2U
#define RDD2_ZROS_SERIAL_CRC_SEED     0xffffU

struct rdd2_zros_serial_stats {
	uint32_t rx_frames;
