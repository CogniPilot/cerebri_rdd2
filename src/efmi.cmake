...
if(DEFINED ENV{RDD2_RUMOCA_EXECUTABLE_SHA256} AND
...
function(rdd2_add_efmi_control_model model_file model_name generated_name)
  ...
  set(RDD2_EFMI_SOURCE_${generated_name} ${_source} PARENT_SCOPE)
  set(RDD2_EFMI_KERNEL_SOURCE_${generated_name} ${_kernel_source} PARENT_SCOPE)
...
set(RDD2_EFMI_SHARED_KERNEL_SOURCE ${_shared_kernel_source})
